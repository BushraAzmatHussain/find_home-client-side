...
const Rent = () => {
    return (
        <div className='text-center mx-10'>
            <h1 className='font-extrabold font-mono text-4xl my-10'>SELL </h1>
            
            <div className='grid 2xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-1 sm:grid-cols-1'>
                ...
                <div className="card mb-8  w-72 h-44 shadow-xl hero opacity-90 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300" style={{
                    ...
                    <div className="card-body ">
                        ...
                        <Link to="/sellDhaka" className='text-5xl  text-white hover:text-amber-400 mx-20 mb-20' >< BsArrowRightCircle></BsArrowRightCircle></Link>
                    </div>
                </div>
