...
const FeaturedApertments = () => {
	return (
		<div className=' pt-8'>
			<h1 className='text-center padding-text font-bold drop-shadow-2xl rainbow-text'>
			...
			<div className='flex min-h-screen items-center justify-center'>
				<div className='grid grid-cols-1 gap-8 p-8 md:grid-cols-2 lg:grid-cols-3 padding-features container'>
					<div className='group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg cards'>
						...
						<div className='absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0'>
							<h1 className='font-dmserif text-3xl font-bold text-yellow-400'>
								Brand New Apartment
							</h1>
							<p className='mb-3 text-xl italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
								650 EGP/day
								<br />
								4 Bath
								<br />
